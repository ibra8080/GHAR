...
const jobs = [
  { title: "Field Coordinator", location: "Sudan / Yemen", type: "Full-time", desc: "Coordinate humanitarian aid distribution and manage relationships with local partners on the ground." },
  { title: "Medical Volunteer", location: "Sudan", type: "Volunteer", desc: "Provide medical care in mobile clinics and refugee camps. Doctors, nurses, and pharmacists welcome." },
  { title: "Communications Officer", location: "Remote / Bremen", type: "Part-time", desc: "Manage social media, write reports, and communicate our impact to donors and the public." },
  { title: "Finance & Compliance Officer", location: "Bremen, Germany", type: "Full-time", desc: "Oversee financial reporting, ensure compliance with German NGO regulations, and manage donor records." },
];
            ...
            <div key={i} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className={`text-xs px-3 py-1 rounded-full font-medium ${
                  job.type === "Volunteer" ? "bg-secondary/10 text-secondary"
              ...
              <button className="text-primary text-sm font-medium hover:underline">{t("applyNow")}</button>
            </div>
          ))}
        </div>
      </section>
