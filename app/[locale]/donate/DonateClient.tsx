...
export default function DonateClient({
  ...
  const launchgoodUrl = siteSettings?.launchgoodUrl || 'https://www.launchgood.com';
  ...
  const handleDonate = async () => {
    ...
    setStatus("success");
    window.open(`https://www.paypal.com/donate?business=${paypalEmail}&amount=${finalAmount}&currency_code=EUR`, "_blank");
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="md:col-span-2">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            {status === "success" && <p className="text-secondary text-sm text-center mb-4">{t("successMessage")}</p>}
            {status === "error" && <p className="text-red-500 text-sm text-center mb-4">{t("errorMessage")}</p>}
        ...
        <div className="md:col-span-1 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="flex flex-col gap-3">
              <a href={launchgoodUrl} target="_blank" rel="noopener noreferrer"
              ...
              <div className="border border-gray-100 rounded-lg p-4">
                ...
                <p className="text-gray-500 text-xs">IBAN: {bankIban}</p>
                <p className="text-gray-500 text-xs">BIC: {bankBic}</p>
                <p className="text-gray-500 text-xs">Bank: {bankName}</p>
              </div>
            </div>
          </div>
        </div>
