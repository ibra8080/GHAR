...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-background border-b-1 border-primary sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end h-20 pb-3">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="/about" className="text-primary hover:text-[#2A2A2A] transition-colors text-sm font-medium">
              About US
            </Link>
            <Link href="/projects" className="text-primary hover:text-[#2A2A2A] transition-colors text-sm font-medium">
              Our Projects
            </Link>
            <Link href="/volunteer" className="text-primary hover:text-[#2A2A2A] transition-colors text-sm font-medium">
              Volunteer
            </Link>
            <Link href="/contact" className="text-primary hover:text-[#2A2A2A] transition-colors text-sm font-medium">
              Contact US
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button className="text-primary hover:text-[#2A2A2A] transition-colors p-1">
              <Search size={18} />
            </button>
            ...
            <span className="text-gray-300">|</span>
            <button className="text-primary hover:text-[#2A2A2A] transition-colors text-sm font-medium">
              EN
            </button>
            <Link
              href="/donate"
              className="bg-secondary hover:bg-green-700 text-white px-5 py-2 rounded text-sm font-semibold transition-colors ml-2"
            >
              Donate Now
            </Link>
          </div>
